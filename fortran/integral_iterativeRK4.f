      ...
      module m2
        ...
        function iterativeRK4(n,vector,x_old,x) result(v)
          ...
          v = vector
          t = x_old
!Escoger el aumento correcto es un problema conocido como "adaptive step-size",
!que requiere un metodo distinto, ejemplos de metodo
!solución son "RK45" o "RK23", que lleva una estimación de error para el valor a
